...
const Contact = () => {
  ...
  const onSubmit = async (e) => {
    const isValid = await trigger(); // Perform form validation

    if (!isValid) {
      e.preventDefault(); // If not valid then do not proceed Form submission
    }
  };
      ...
      <div className='md:flex md:justify-between gap-16 mt-5'>
        ...
        >
          <form
            target='_blank'
            onSubmit={onSubmit}
            action='https://formsubmit.co/somedummyemail@gmail.com'
            method='POST'
          >
            <input
