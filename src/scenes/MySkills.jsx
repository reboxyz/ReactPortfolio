...
const MySkills = () => {
  ...
  return (
    <section id='skills' className='pt-10 pb-24'>
      ...
      {/* SKILLS Note! When medium or above screen, this will be flex which will in effect
         display horizontally. Otherwise, display vertically as flex will not be applied.
    */}
